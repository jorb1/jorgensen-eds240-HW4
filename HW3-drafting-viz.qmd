...
![](data/Pictorial-Fraction-Chart-1-1.png){fig-alt="image of a person silouette, with a percentage line through it, to visualize a percentage of something.}
*This viz from the datavizproject is simple, but is honestly a great example of what I want to try too, but with a piece of kelp. I have a feeling I'll have to get a little artsy with this one, but I want to try anyway. Obviously, in my final viz, I will have more text and a title that explains what is actually happening here.*

![](data/README-example-map-1.png){fig-alt="Picture of a map of the United States, with Texas colored in a different color, and also magnified in a separate cut-out}
