...
# Load libraries
librarian::shelf(tidyverse, tidync, here, sf, rnaturalearth, terra, tmap, tmaptools, spData, spDataLarge, mapdata, RColorBrewer, ggmagnify, grid)
```
...
*Here is the code for the streamgraph...as I said, the package is not working as intended. I haven't given up on the stream graph concept quite yet, so I am still fiddling with it, and hope to actually have a rendered output soon...*
